...
EXTRA_OPTS	= -fmodulo-sched -fmodulo-sched-allow-regmoves -ftree-loop-distribute-patterns -ftree-slp-vectorize -fvect-cost-model -ftree-partial-pre -fgcse-after-reload -fgcse-lm -fgcse-sm -fsched-spec-load -ffast-math -fsingle-precision-constant -fpredictive-commoning
CORTEX_OPTS	= -march=cortex-a57.cortex-a53 -mtune=cortex-a57.cortex-a53
CFLAGS_MODULE   =
AFLAGS_MODULE   =
